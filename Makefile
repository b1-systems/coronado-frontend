...
#dirty test for build#I18NEXT_PARSER_CONFIG = i18next-parser.config.js
#dirty test for build#FALLBACK_TRANSLATIONS = src/fallbackTranslations/translation.json
...
#dirty test for build#install -D src/fallbackTranslations/translation.json ${HORDE_BUILD}/locale/json/en/translation.json
...
#dirty test for build#.PHONY: translations-check
#dirty test for build#translations-check: translations ## Exits with 1 if any translations are missing
#dirty test for build#	@! grep '__STRING_NOT_TRANSLATED__' ${FALLBACK_TRANSLATIONS}
